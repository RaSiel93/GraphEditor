...
public class Controller {
	...
	String name = JOptionPane
		.showInputDialog("Введите новое имя для вершины");
	if (name != null) {
	...
	String lenght = JOptionPane
		.showInputDialog("Введите новую длину для ребра");
	...
	for (int numVertex = 0; numVertex < graph.countVertex(); numVertex++) {
	    // Если закомитить деактивацию, то станет возможным выделение рамкой
	    // несколько раз через Ctrl.
     ...
     * JOptionPane.showMessageDialog(null, "Граф двудольный"); } else {
